...
const products = (() => {
    ...
    const text = [
        `Short Brewing was created as a side project to fill the urge of acomplishing something after failing to open a restaurant.
        ...
        <br><br><br>
        Short Brewing is (was) a non-existant (but legal) very-micro brewery. 
        <br>
        ...
        Being gipsys is one of the reasons for the downfall of our great company. Problem is you don't choose when your next batch
        ...
        <br><br><br>
        (The logo on the center of the bottle are my aquarella painted balls. Long story...)`
    ];
    const render = () => {
